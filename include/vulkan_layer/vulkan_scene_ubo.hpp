...
inline glm::mat4
computeLightView (const glm::vec3& lightDir, const glm::vec3& sceneCenter, float distance) {
...
struct VulkanSceneUBO {
    ...
    VulkanSceneUBO ()
    : view (1.0f), proj (1.0f), lightView (1.0f), lightProj (1.0f),
      lightColor (0.0f, 0.0f, 0.0f), groundColor (1.0f, 1.0f, 1.0f),
