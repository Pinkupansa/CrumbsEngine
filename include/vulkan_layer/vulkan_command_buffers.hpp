...
class VulkanCommandBuffers {
    ...
    VulkanCommandBuffers (const VulkanDevice& device, const VulkanFramebuffers& framebuffers)
    : pDevice (device) {
    ...
    void record (VkExtent2D renderAreaExtent,
        ...
        createRenderPassBeginInfo (renderPass.getRenderPass (),
                                   framebuffers.getFramebuffers ()[commandBufferIndex],
                                   clearValues, renderAreaExtent);

        vkCmdBeginRenderPass (commandBuffers[commandBufferIndex],
