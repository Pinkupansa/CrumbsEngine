...
int main() {
    ...
    VulkanUBDescriptor staticObjectsUBDescriptor(device, staticObjectsUB, VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT, sizeof(UniformBufferObject));

    VulkanBuffer sceneDataUB(device, VulkanBufferType::Uniform, sizeof(SceneUBO), &sceneData, false, 0, "Scene UB");
    VulkanUBDescriptor sceneDataUBDescriptor(device, sceneDataUB, VK_SHADER_STAGE_VERTEX_BIT | VK_SHADER_STAGE_FRAGMENT_BIT, sizeof(SceneUBO));
